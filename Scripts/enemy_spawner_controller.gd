...
var spawners: Array
@export var spawn_rounds : Array[EnemySpawnRound]
...
func spawn_enemy(enemy_to_spawn: PackedScene = null, spawn_position: Vector2 = Vector2.ONE):
	...
	var inst = Globals.create_instance(enemy, pos)
	enemies.append(inst)


func get_enemy_to_spawn() -> PackedScene:
	return spawn_rounds[spawn_round].enemies[Globals.get_weighted_index(spawn_rounds[spawn_round].enemies)].object_to_spawn
