...
func _ready():
	...
	# animate stats
	tween2.tween_property(time_text, "text", "[center]" + time, 0.25)
	#tween2.tween_property(best_time_text, "text", Globals.time_to_minutes_secs_mili(SaveData.best_time), 0.25)
